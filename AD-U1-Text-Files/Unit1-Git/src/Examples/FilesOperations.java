...
public class FilesOperations {
	...
	public static void main(String[] args) {
		...
		Path p1 = Paths.get("input.txt");
		Path p2 = Paths.get("d1");
		Path p3 = Paths.get("nonexisting");
		/*
		 * p4 is a file with no reading access to anybody,including the owner
		 */
		Path p4 = Paths.get("noAccess.txt");
